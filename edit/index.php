...
<html lang="pt-br">
	...
	<body>
		...
		while($row_usuario = mysqli_fetch_assoc($resultado_usuarios)){
			...
			echo "Numero: " . $row_usuario['numero_casa'] . "<br>";
			echo "Cidade: " . $row_usuario['cidade'] . "<br>";
			echo "Estado: " . $row_usuario['estados_brasil'] . "<br>";
			echo "Zona: " . $row_usuario['zona'] . "<br>";
			echo "Residencia: " . $row_usuario['residencia'] . "<br>";
			echo "Terreno: " . $row_usuario['terreno'] . "<br>";
			echo "Status: " . $row_usuario['processa_status'] . "<br>";
			echo "Data e hora de cadastro: " . $row_usuario['created'] . "<br>";
